...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        $error = 'Passwords do not match. Please ensure both passwords are the same.';
                ...
                <div class="glass-card p-4 sm:p-6 md:p-8 animate-fade-in-up animate-delay-200">
                        ...
                        <div class="flex items-start animate-fade-in-up animate-delay-500">
                            <div class="flex items-center h-5">
                                <input
                                    ...
                                    id="terms"
                                    name="terms"
                                    class="h-4 w-4 text-[var(--accent)] focus:ring-[var(--accent)]"
                                    required
                                >
                            </div>
                            <div class="ml-3 text-xs sm:text-sm">
                                <label for="terms" class="text-gray-600">
                                    I agree to the <a href="#" class="text-[var(--accent)] hover:text-[var(--primary)]">Terms and Conditions</a> and <a href="#" class="text-[var(--accent)] hover:text-[var(--primary)]">Privacy Policy</a>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 md:mt-8 animate-fade-in-up animate-delay-500">
                        ...
                        <div class="mt-4 md:mt-6">
                            <a href="index.html" class="text-xs sm:text-sm text-[var(--dark)] hover:text-[var(--primary)] flex items-center">
